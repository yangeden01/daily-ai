...
const worksheetColumns: Record<string, Partial<ExcelJS.Column>[]> = {
  [worksheetNames.events]: [
    ...
    { header: 'calendarType', key: 'calendarType', width: 14 },
    { header: 'lunarMonth', key: 'lunarMonth', width: 14 },
    { header: 'lunarDay', key: 'lunarDay', width: 14 },
    { header: 'isLeapMonth', key: 'isLeapMonth', width: 14 },
    { header: 'targetYear', key: 'targetYear', width: 14 },
  ],
  [worksheetNames.tags]: [
    { header: 'id', key: 'id', width: 24 },
